...
return {
  ...
  keys = {
    ...
    { '<leader>dx', debug_hover.focus_or_open, desc = 'e[x]amine', mode = { 'n', 'x' } },
    ...
    { '<leader>dj', function() require('dap').down() end, desc = ' frame' },
    { '<leader>dk', function() require('dap').up() end, desc = ' frame' },
