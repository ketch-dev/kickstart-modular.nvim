...
vim.api.nvim_create_autocmd('User', { group = overlay_group, pattern = 'MiniDiffUpdated', callback = function(args) sync_overlay(args.buf) end })
vim.api.nvim_create_autocmd('VimEnter', { group = overlay_group, callback = function() vim.schedule(sync_all_overlays) end })
vim.api.nvim_create_autocmd({ 'BufWinEnter', 'WinEnter', 'WinClosed' }, { group = overlay_group, callback = function() vim.schedule(sync_all_overlays) end })
