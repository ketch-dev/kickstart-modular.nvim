      ...
      require('diffview').setup {
        ...
        keymaps = {
          file_history_panel = {
            ...
            ['<right>'] = false,
            close,
            { 'n', 'j', preview_entry.move_and_preview(actions.next_entry), { desc = 'Next entry + preview commit' } },
            { 'n', 'k', preview_entry.move_and_preview(actions.prev_entry), { desc = 'Prev entry + preview commit' } },
          },
          option_panel = { close },
          help_panel = { close },
          view = {
          ...
          file_panel = {
            ...
            ['<cr>'] = false,
            close,
            { 'n', 'j', preview_entry.move_and_preview(actions.next_entry), { desc = 'Next entry + preview file' } },
            { 'n', 'k', preview_entry.move_and_preview(actions.prev_entry), { desc = 'Prev entry + preview file' } },
            { 'n', 'h', fold_action(actions.close_fold), { desc = 'Collapse folder' } },
            { 'n', 'l', fold_action(actions.open_fold), { desc = 'Expand folder' } },
            { 'n', '<cr>', open_entry.open_file_and_close_diffview, { desc = 'Open file and close Diffview' } },
          },
        },
      }
